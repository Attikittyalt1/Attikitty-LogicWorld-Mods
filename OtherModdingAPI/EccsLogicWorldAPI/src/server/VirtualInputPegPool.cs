...
namespace EccsLogicWorldAPI.Server
{
	public static class VirtualInputPegPool
	{
		...
		public static InputPeg borrowPeg(bool isDuringComponentCreation = false)
		{
			...
			if(rootAddress == ComponentAddress.Empty)
			{
				...
				rootAddress = isDuringComponentCreation ? 
					UnusedComponentAddressGrabber.getUnusedComponentAddressOneAhead() : 
					UnusedComponentAddressGrabber.getUnusedComponentAddress();
			}
