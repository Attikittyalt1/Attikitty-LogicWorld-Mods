...
namespace EccsLogicWorldAPI.Server.Generators
{
	public static class UnusedComponentAddressGrabber
	{
        ...
        public static ComponentAddress getUnusedComponentAddressOneAhead()
		{
			if (unusedComponentAddresses.Count < 2)
			{
                return ComponentAddressGrabber.getNewComponentAddress(1);
            }

            unusedComponentAddresses.Dequeue();
            return unusedComponentAddresses.Dequeue();
        }
