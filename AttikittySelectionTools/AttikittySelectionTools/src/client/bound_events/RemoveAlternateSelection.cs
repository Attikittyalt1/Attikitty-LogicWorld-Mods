...
public class RemoveAlternateSelection : BuildingOperation
{
    ...
    public override InputTrigger OperationStarter => Triggers.RemoveAlternateSelection;
    ...
    public override bool CanOperateOn(ComponentSelection selection)
    {
        ...
        if (!Clipboard.ContainsAnyAddressFromSelection(selection))
        {
            return false;
        }
    ...
    {
        Clipboard.RemoveSelection(selection);
    }
