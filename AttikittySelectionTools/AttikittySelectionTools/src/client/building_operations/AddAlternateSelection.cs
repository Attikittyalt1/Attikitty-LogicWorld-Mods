...
public class AddAlternateSelection : BuildingOperation
{
    ...
    public override bool CanOperateOn(ComponentSelection selection)
    {
        ...
        if (Manager.ContainsEveryAddressFromSelection(selection)) return false;
    ...
    public override InputTrigger OperationStarter => Inputs.Triggers.AddAlternateSelection;
}